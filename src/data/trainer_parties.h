...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BIND, MOVE_ROCK_THROW, MOVE_SCREECH}
    },
    {
    .iv = 100,
    .lvl = 14,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER_SHOCK, MOVE_TACKLE}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EMBER, MOVE_METAL_CLAW, MOVE_SMOKESCREEN}
    },
    {
    .iv = 200,
    .lvl = 16,
    ...
    .moves = {MOVE_ROCK_THROW, MOVE_THUNDER_WAVE, MOVE_PROTECT, MOVE_SANDSTORM}
    }
};    
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .moves = {MOVE_ICY_WIND, MOVE_ICE_BALL, MOVE_TACKLE, MOVE_GROWL}
    }
};
